...
export const socialLinks = [
    ...
    { name: "Events", url: "https://luma.com/defihouse42", icon: <LumaIcon /> },
    { name: "GitHub", url: "https://github.com/defihouse42", icon: <GitHubIcon /> },
]

// Direct access to individual social links
export const socials = {
    ...
    github: { name: "GitHub", url: "https://github.com/defihouse42", icon: <GitHubIcon /> },
} as const

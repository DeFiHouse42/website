    ...
    >
      <div className="max-w-4xl m-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          {/* Latest Tweet Embed */}
          <div>
            <h3 className="text-2xl font-bold mb-8 text-white">Follow us on X</h3>

            <div className="space-y-8">
              <div className="bg-gray-900/50 border border-green-400/20 rounded-lg overflow-hidden p-4">
                <LatestTweet />
